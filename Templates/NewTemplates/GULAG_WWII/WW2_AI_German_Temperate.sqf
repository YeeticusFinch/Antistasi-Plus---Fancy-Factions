...
_sfLoadoutData setVariable ["uniforms", ["U_LIB_GER_unterofficer_WssFrsbrgOschaMp40"]];
_sfLoadoutData setVariable ["vests", ["V_LIB_GER_VestUnterofficer"]];
_sfLoadoutData setVariable ["Hvests", ["V_LIB_GER_VestUnterofficer"]];
