...
A3A_logistics_vehicleHardpoints = [
    ...
    ["C_Offroad_01_F" call A3A_fnc_classNameToModel, [
     ...
     //Soviet trucks
    ["VIOC_O_LIB_Zis5v" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.3,-0.615],      []],
        [1,             [0,-0.9,-0.615],      []],
        [1,             [0,-1.5,-0.615],         []],
        [1,             [0,-2.1,-0.615],           []]
        ]],
    ["VIOC_O_LIB_US6_Tent" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.7475,0.25],      []],
        [1,             [0,-1.4375,0.25],      []],
        [1,             [0,-2.2,0.25],         []],
        [1,             [0,-3,0.25],           []]
        ]],
    ["VIOC_O_LIB_US6_Open_Cargo" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.7475,0.25],      []],
        [1,             [0,-1.4375,0.25],      []],
        [1,             [0,-2.2,0.25],         []],
        [1,             [0,-3,0.25],           []]
     ...
     //German jeeps
	["VIOC_B_LIB_Kfz1" call A3A_fnc_classNameToModel, [
        // always 1,    location                locked seats
        [1,             [-0.116,-1.318,0],          []]
    ]],
    ["VIOC_B_LIB_Kfz1_hood" call A3A_fnc_classNameToModel, [
        // always 1,    location                locked seats
        [1,             [-0.116,-1.318,0],          []]
    ]],
    //German APCs
    ["VIOC_B_LIB_SdKfz251" call A3A_fnc_classNameToModel, [
        // always 1,    location                locked seats
        [1,             [-0.13,-0.5,-1],          []],
        [1,             [-0.13,-1,-1],          []],
        [1,             [-0.13,-1.5,-1],          []],
    ...
    ["VIOC_B_LIB_SdKfz251_FFV" call A3A_fnc_classNameToModel, [
        // always 1,    location                locked seats
        [1,             [-0.13,-0.5,-1],    		   []],
        [1,             [-0.13,-1,-1],      		   []],
        [1,             [-0.13,-1.5,-1],  	       []],
    ...
    //German trucks
    ["VIOC_B_LIB_OpelBlitz_Tent_Y_Camo" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.1,-0.05],      []],
        [1,             [0,-0.1,-0.05],      []],
        [1,             [0,-0.1,-0.05],      []],
        [1,             [0,-0.1,-0.05],      []]
        ]],
    ["VIOC_B_LIB_OpelBlitz_Open_Y_Camo" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.1,-0.05],      []],
        [1,             [0,-0.8,-0.05],      []],
        [1,             [0,-1.5,-0.05],      []],
        [1,             [0,-2.2,-0.05],      []]
        ]],
    ["VIOC_B_LIB_SdKfz_7" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.4,-0.75],      []],
        [1,             [0,-1.1,-0.75],      []],
        [1,             [0,-1.8,-0.75],      []],
        [1,             [0,-2.5,-0.75],      []]
        ]],
    //Rebel and civilian trucks
    ["LIB_pol_opelblitz_open_Tarn_Czata" call A3A_fnc_classNameToModel, [
        [1,             [0,-0.1,-0.05],      []],
        [1,             [0,-0.8,-0.05],      []],
        [1,             [0,-1.5,-0.05],      []],
        [1,             [0,-2.2,-0.05],      []]
        ]],
    ["LIB_FRA_CitC4" call A3A_fnc_classNameToModel, [
        [1,             [0,0,-0.615],      []],
        [1,             [0,-0.7,-0.615],      []],
        [1,             [0,-1.4,-0.615],      []],
        [1,             [0,-2.1,-0.615],      []]
        ]],
    ["LIB_FRA_CitC4Ferme" call A3A_fnc_classNameToModel, [
        [1,             [0,0,-0.615],      []],
        [1,             [0,-0.7,-0.615],      []],
        [1,             [0,-1.4,-0.615],      []],
        [1,             [0,-2.1,-0.615],      []]
