...
["flagTexture", "\A3\Data_F\Flags\Flag_rcrystal_CO.paa"] call _fnc_saveToTemplate;
...
["vehicleFuel", "O_SWOP_landspeeder_1"] call _fnc_saveToTemplate;

["vehiclePlane", "swop_xw"] call _fnc_saveToTemplate;
["vehiclePayloadPlane", "swop_MF"] call _fnc_saveToTemplate;
["vehicleHeli", "Swop_Uwing"] call _fnc_saveToTemplate;

["vehicleCivCar", "O_SWOP_landspeeder_1"] call _fnc_saveToTemplate;
...
["staticAA", "HighTur"] call _fnc_saveToTemplate;
...
//black market stuff
shop_UAV = ["SWOP_Rebel_Dio_Droid"];
shop_AA = ["3AS_RX200_Base"];
shop_MRAP = ["3as_RTT"];
shop_wheel_apc = ["O_SWOP_HoverTa_2", "O_SWOP_HoverTf_2"];
shop_track_apc = ["O_SWOP_HoverTa_2"];
shop_heli = ["Swop_Uwing"];
shop_tank = ["3as_ATTE_Base"];
shop_plane = ["swop_xw", "swop_yw", "swop_aw", "swop_Vwing"];

additionalShopLight = ["3AS_Barc"];
additionalShopAtgmVehicles = [];
additionalShopManpadsVehicles = [];
additionalShopArtillery = ["3as_AV7", "3as_ATAP_Base"];
