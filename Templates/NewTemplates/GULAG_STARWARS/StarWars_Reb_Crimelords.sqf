...
["name", "Hutt Cartel"] call _fnc_saveToTemplate; //Doesn't have to be the faction's official name
...
["vehicleLightUnarmed", "O_SWOP_Skif_1"] call _fnc_saveToTemplate; //Essentially the Toyota Hilux equivalent for your faction
["vehicleLightArmed", "O_SWOP_Skif_1"] call _fnc_saveToTemplate;  //Basic technical
["vehicleTruck", "O_SWOP_Khetanna_1"] call _fnc_saveToTemplate;       //The Big Boi Trucks
...
["vehicleRepair", "O_SWOP_Khetanna_1"] call _fnc_saveToTemplate;      //Repair truck
["vehicleFuel", "O_SWOP_Khetanna_1"] call _fnc_saveToTemplate;        //Fuel truck

["vehiclePlane", "SWOP_yw"] call _fnc_saveToTemplate;       //Basic plane that will spawn after calling airstrikes n stuff
["vehiclePayloadPlane", "Swop_Uwing"] call _fnc_saveToTemplate; //I think this is for supply drop missions? idk
["vehicleHeli", "Swop_Uwing"] call _fnc_saveToTemplate;        //Helicopter
...
["staticMG", "EWEBSWBF"] call _fnc_saveToTemplate;        //Rebel static weapons
...
["baseSoldiers", [ // Cases matter. Lower case here because allVariables on namespace returns lowercase
	["militia_unarmed", "SWOP_Band_week_a280"],     //Default units for friendly AI
	["militia_rifleman", "SWOP_Band_week_a280"],
	["militia_staticcrew", "SWOP_Band_week_a280"],
	["militia_medic", "SWOP_Band_week_smug"],
	["militia_sniper", "SWOP_Band_week_sniper"],
	["militia_marksman", "SWOP_Band_week_sniper"],
	["militia_lat", "SWOP_Band_week_aa"],
	["militia_machinegunner", "SWOP_Band_week_assault"],
	["militia_explosivesexpert", "SWOP_Band_week_smug"],
	["militia_grenadier", "SWOP_Band_week_smug"],
	["militia_squadleader", "SWOP_Band_week_serg"],
	["militia_engineer", "SWOP_Band_week_smug"],
	["militia_at", "SWOP_Band_week_aa"],
	["militia_aa", "SWOP_Band_week_aa"],
	["militia_petros", "SWOP_Band_trando_com"]
]] call _fnc_saveToTemplate;
...
//black market stuff
shop_UAV = ["SWOP_Dio_Droid"];     //Military vehicles that u can buy off the black market
shop_AA = ["3AS_Rx200_Base"];
shop_MRAP = ["O_SWOP_HoverT_1"];
shop_wheel_apc = ["O_SWOP_HoverTa_1"];
shop_track_apc = ["O_SWOP_HoverTr_1"];
shop_heli = ["3AS_Patrol_LAAT_Imperial"];
shop_tank = ["3as_saber_m1"];
shop_plane = ["3as_Z95_green"];

additionalShopLight = ["SW_SpeederBike"];
additionalShopAtgmVehicles = ["O_SWOP_HoverTr_1"];
additionalShopManpadsVehicles = ["O_SWOP_HoverTr_1"];
additionalShopArtillery = ["O_SWOP_HoverTr_1"];
